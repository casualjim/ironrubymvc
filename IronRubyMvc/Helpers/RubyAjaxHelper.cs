...
namespace System.Web.Mvc.IronRuby.Helpers
{
    public class RubyAjaxHelper : AjaxHelper
    {
        ...
        public MvcHtmlString ActionLink(string linkText, string actionName, Hash routeValues, AjaxOptions ajaxOptions)
        {
            return _helper.ActionLink(linkText, actionName, routeValues.ToRouteDictionary(), ajaxOptions);
        }

        public MvcHtmlString ActionLink(string linkText, string actionName, Hash routeValues, AjaxOptions ajaxOptions, Hash htmlAttributes)
        {
        ...
        public MvcHtmlString ActionLink(string linkText, string actionName, string controllerName, Hash routeValues, AjaxOptions ajaxOptions)
        {
            return _helper.ActionLink(linkText, actionName, controllerName, routeValues, ajaxOptions, null /* htmlAttributes */);
        }

        public MvcHtmlString ActionLink(string linkText, string actionName, string controllerName, Hash routeValues, AjaxOptions ajaxOptions, Hash htmlAttributes)
        {
        ...
        public MvcHtmlString RouteLink(string linkText, Hash routeValues, AjaxOptions ajaxOptions)
        {
            return _helper.RouteLink(linkText, routeValues.ToRouteDictionary(), ajaxOptions);
        }

        public MvcHtmlString RouteLink(string linkText, Hash routeValues, AjaxOptions ajaxOptions, Hash htmlAttributes)
        {
            return _helper.RouteLink(linkText, routeValues.ToRouteDictionary(), ajaxOptions, htmlAttributes.ToDictionary());
        }

        public MvcHtmlString RouteLink(string linkText, string routeName, AjaxOptions ajaxOptions)
        {
        ...
        public MvcHtmlString RouteLink(string linkText, string routeName, Hash routeValues, AjaxOptions ajaxOptions)
        {
            return _helper.RouteLink(linkText, routeName, routeValues.ToRouteDictionary(), ajaxOptions);
        }

        public MvcHtmlString RouteLink(string linkText, string routeName, Hash routeValues, AjaxOptions ajaxOptions, Hash htmlAttributes)
        {
